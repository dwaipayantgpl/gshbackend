...
async def forwards():
    ...
    manager.drop_table(
        class_name="BookingRequest", tablename="booking_request", schema=None
    )
    ...
    manager.add_column(
        table_class_name="ServiceBooking",
        tablename="service_booking",
        column_name="work_details",
        db_column_name="work_details",
